# Cliffwald Online GDD v3.3 Draft - User Input

**Status:** Non-authoritative user-provided draft for zero-trust audit.
**Captured:** 2026-07-01
**Audit:** `docs/design/audits/GDD_V3_3_ZERO_TRUST_AUDIT.md`

This file preserves the draft text received from the user. It is not the active GDD and must not override `docs/design/GDD_MASTER.md`.
 ...
 * **Magia Táctil:** El lanzamiento de hechizos es físico (dibujo real), priorizando la satisfacción del gesto sobre la seguridad del servidor.
 ...
 * **Validación:** El **Cliente** determina si el dibujo es correcto.
 * **Red:** El cliente envía la orden ("Cast Spell X") al servidor.
 * **Riesgo Aceptado:** Se asume la posibilidad de *cheats* a cambio de eliminar la latencia.
