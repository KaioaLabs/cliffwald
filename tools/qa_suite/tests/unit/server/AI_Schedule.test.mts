...
import { getStudentScheduleTarget } from "../../../../../src/shared/utils/ScheduleUtils";
import { RoutineState } from "../../../../../src/server/ai/states/RoutineState";
import { LevelRegistry } from "../../../../../src/server/managers/LevelRegistry";
import { Entity } from "../../../../../src/shared/ecs/components";
...
describe("MMO AI Schedule Verification", () => {
    ...
    it("09:00 -> Should go to Class (Classroom)", () => {
        ...
        // In V3.3 GDD, strict mapping is CLASSROOM
        expect(target.targetZone).toBe("CLASSROOM");
